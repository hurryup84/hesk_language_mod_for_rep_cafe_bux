...
//resolved wird zu Abgeholt
$hesklang['closed']='Abgeholt'; 
$hesklang['close_this_ticket']='Dieses Gerät als abgeholt kennzeichnen';
...
$hesklang['notclo']='Ein Gerät als abgeholt markiert wird';
$hesklang['statistics']['axis2']='% der Geräte abgeholt';
$hesklang['statistics']['pie_title_ro']='Offene gegen Abgeholte Geräte';

// .replied bleibt bei uns "In Reparatur", weil eine Antwort nur eine interne Information ist und das System ohne Emails konfiguriert ist und es einen neuen, manuell zu setzenden Status "Fertig" gibt
$hesklang['replied']='In Reparatur';
$hesklang['statistics']['answered']='mit Reparaturdetails';
$hesklang['statistics']['unanswered']='Noch ohne Reparaturdetails';
$hesklang['escalate']['nrep']='noch keine Reparaturdetails eingetragen';


$hesklang['can_edit_tickets']='Geräte mit Reparaturdetails bearbeiten';
$hesklang['showtic']='Das soeben bearbeitetes Gerät anzeigen';
$hesklang['ticall']='Bearbeitete Geräte';
$hesklang['atbr']='Dieses Gerät muss zugewiesen werden bevor es fertiggestellt werden kann.';
...
$hesklang['statistics']['axis1']='% der Geräte fertig';
...
$hesklang['end_ticket']='--- Ende der Gerätebeschreibung ---';
...
$hesklang['can_del_notes']='Anmerkungen zu Geräte löschen';
$hesklang['dan']='Mitarbeiter können prinzipiell ihre eigenen Anmerkungen zu Geräten löschen, daher nur auswählen wenn Benutzer auch Notizen <strong>anderer</strong> Benutzer löschen dürfen!';
...
$hesklang['dele']='Dieses Gerät löschen';
$hesklang['aftrep']='Nach Beantwortung eines Gerätes';

$hesklang['shownext']='Nächstes offenes Gerät öffnen (Verwaltungsübersicht öffnet sich autom. wenn keine offenen Geräte vorhanden sind)';
$hesklang['rssn']='Nächstes Gerät anzeigen das bearbeitet werden soll';
$hesklang['chpri2']='Priorität des Gerätes geändert in %s';
$hesklang['genl2']='Diesen Link verwenden um eine Kategorie für das Formular &quot;Ein Geräte übermitteln&quot; vorzugeben.';
$hesklang['asst2']='Dieses Gerät zuweisen an:';
$hesklang['asss2']='Dieses Gerät mir selbst zuweisen';
...
$hesklang['tasy']='Dieses Gerät wurde zugewiesen';
$hesklang['taso']='Dieses Gerät wurde dem ausgewählten Benutzer zugewiesen';
$hesklang['tunasi']='Geräte nicht zugewiesen';
$hesklang['nyt']='Dieses Gerät ist zugewiesen an';
...
$hesklang['tlock']='Gerät wurde gesperrt';
$hesklang['tunlock']='Gerät wurde freigegeben';
$hesklang['tislock']='Gerät wurde gesperrt - der Kunde kann keine Antwort mehr hinzufügen.';
$hesklang['tislock2']='Gerät wurde gesperrt - es können keine Antworten mehr hinzugefügt werden.';
$hesklang['thist7']='<li class="smaller">%s &#124; Geräte eröffnet von %s</li>'; // %s = date, user making change
$hesklang['elocked']='Gerät wurde gesperrt oder gelöscht.';
$hesklang['nti2']='Ein neues Gerät anlegen';
...
$hesklang['ntam']='Mir ein Gerät zugewiesen wird';
$hesklang['ycvtao']='Keine Erlaubnis Geräte einzusehen welche anderen zugewiesen sind';
$hesklang['seqid']='Gerätenummer';
$hesklang['archived2']='Markiertes Gerät';
$hesklang['add_archive']='Markiere dieses Gerät';
$hesklang['add_archive_quick']='Markiere ausgewählte Geräte';
$hesklang['remove_archive']='Demarkiere dieses Gerät';
...
$hesklang['added2archive']='Gerät wurde markiert';
$hesklang['removedfromarchive']='Gerät wurde demarkiert';
...
$hesklang['perat']='%s von allen Geräten'; // Will change to "23% of all Geräte"
$hesklang['tsst']='Gerätetatus wurde gesetzt auf %s';
$hesklang['aaon']='Autom. Zuweisung von Geräten ist aktiviert (zum Deaktivieren klicken)';
$hesklang['aaoff']='Autom. Zuweisung von Geräten ist deaktiviert (zum Aktivieren klicken)';
$hesklang['uaaon']='Autom. Zuweisung von Geräten wurde für den ausgewählten Mitarbeiter aktiviert';
$hesklang['uaaoff']='Autom. Zuweisung von Geräten wurde für den ausgewählten Mitarbeiter deaktiviert';
$hesklang['taasy']='Dieses Gerät wurde mir automatisch zugewiesen';
...
$hesklang['import_kb']='Dieses Gerät in einen Artikel der Wissendatenbank importieren';
...
$hesklang['saass']='Autom. Zuweisung von Geräten';
$hesklang['noopen']='Keine offenen Gerät zu dieser Emailadresse gefunden.';
$hesklang['ntnote']='Andere Person hat eine Notiz zu einem mir zugewiesenen Gerät hinzugefügt';
$hesklang['cat_aa']='Autom. Zuweisung von Geräte in diese Kategorie.';
$hesklang['user_aa']='Autom. Zuweisung von Geräten für diesen Mitarbeiter aktivieren.';
$hesklang['oo']='Nur offene Reparaturen anzeigen';
...
$hesklang['tme1']='Gerät %s wurde mit Gerät %s zusammengelegt';
$hesklang['tme2']='Um auf Gerät %s zugreifen zu können bitte die passende Emailadresse eingeben.';
$hesklang['thist']='Geräteverlauf';
$hesklang['thist13']='<li class="smaller">%s &#124; Zusammengelegt mit Gerät %s von %s</li>'; // %s = date, merged ticket ID, user making change
$hesklang['autoss']='Autom. Start der Zeitzählers wenn ein Gerät geöffnet wird';
...
$hesklang['sconfe2']='Email Bestätigungsfeld im Formular &quot;Ein Gerät übermitteln&quot; anzeigen';
$hesklang['wrepo']='Bitte eine Antwort schreiben nachdem das Gerät wiedereröffnet wurde.';
...
$hesklang['cat_pri']='Die Kategorie-Priorität wird verwendet wenn es Kunden nicht erlaubt ist einem Gerät eine Priorität zuzuordnen das über die Kundenoberfläche gelegt wurde';
$hesklang['mm1']='Aktuell können Gäste des Reparaturcafes keine Geräte selber anmelden.';
$hesklang['banemail_intro']='Das Einreichen von Geräten durch bestimmte Emailadressen verhindern';
...
$hesklang['notnew']='Ein neues Gerät eingereicht wird';
...
$hesklang['yhbr']='Aufgrund zu vieler Antworten auf ein Gerät, wurde dieses Konto für %s Minuten vom System blockiert.';
$hesklang['attm']='Mir dieses Gerät zuweisen';
$hesklang['taat']='Dieses Gerät ist bereits an <b>%s</b> zugeordnet';
$hesklang['scoy']='Sicher dieses Gerät selbst zuweisen?';
$hesklang['scot']='Sicher dieses Gerät an <b>%s</b> zuweisen?';
...
$hesklang['desc_new_note']='(Mitarbeiter) Neue Notiz auf einem mir zugewiesenen Gerät';
...
$hesklang['confirm_anony']='Dieses Gerät anonymisieren';
$hesklang['privacy_anon_info']='Entferne alle persönlich identifizierbaren Daten und Inhalte von Gerät (Kundenname, E-Mail, Nachricht, Anhänge, IP ...), aber behalte Gerät in der Datenbank für Statistiken (DSGVO: Recht vergessen zu werden).';
...
$hesklang['btn_lock']='Gerät sperren';
$hesklang['btn_tag']='Gerät markieren';
$hesklang['btn_untag']='Gerätemarkierung entfernen';
$hesklang['btn_anony']='Gerät anonymisieren';
$hesklang['btn_delt']='Gerät löschen';
...
$hesklang['confirm_delete_ticket']='Sind Sie sicher, dass Sie dieses Gerät dauerhaft löschen möchten?';
...
$hesklang['antdemo']='Das Einreichen von Geräten über das Admin-Panel wurde im Demo-Modus deaktiviert.<br><br>Bitte verwenden Sie die <a href="%s" target="_blank">öffentliche Seite</a> um ein Testgerät einzureichen.';
